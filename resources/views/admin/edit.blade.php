            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form class="user" action="/archives/update/{{$oldArticle->id}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 mb-4">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    @if($oldArticle->Type=='Image')
                                                    <label for="">Ancienne image</label>
                                                        <img id="image" class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                                            src="{{asset($oldArticle->URL_Image)}}" alt="...">
                                                    @else
                                                        <video width="400" controls style="height:172px; width: 236px;">
                                                            <source style="height: 250px" src={{asset($oldArticle->URL_Image)}} type="video/mp4" class="figure-img img-fluid rounded" width="240" height="145">
