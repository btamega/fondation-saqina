...
<body id="page-top">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <a href="#user" class="d-block card-header py-3" data-toggle="collapse"
                                        ...
                                        <h6 class="m-0 font-weight-bold text-primary">Tous les messages</h6>
                                    </a>
                                            ...
                                            <table class="table table-bordered" id="dataTable" cellspacing="0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$message->Email}}</td>
                                                        <td>
                                                            <a data-toggle="modal" data-target="#message-{{$message->id_commentaire}}" style="width: 0.5rem; height: 1.5rem;" href="{{URL::to('message/'.$message->id_commentaire)}}">
                                                                Lire
                                                            </a>
                                                        </td>
                                                        <td>{{$message->created_at}}</td>
                                                        <td>
                                                            <a style="width: 0.5rem; height: 1.5rem;" href="{{URL::to('delete/message/'.$message->id_commentaire)}}" class="btn btn-danger btn-circle">
                                                                <i class="fas fa-trash"></i>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                    <div class="modal fade" id="message-{{$message->id_commentaire}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button class="btn btn-secondary" class="close" type="button" data-dismiss="modal">Quitter</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <a href="{{URL::to('deleteAllMessages')}}" class="btn btn-danger" data-toggle="modal" data-target="#deleteAllMessages">Tout supprimer</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="deleteAllMessages" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">Etes-vous sûr de vouloir supprimer tous les messages ?</div>
                <div class="modal-footer">
                    <button class="btn btn-primary" type="button" data-dismiss="modal">Annuler</button>
                    <a class="btn btn-danger" href="{{URL::to('deleteAllMessages')}}">Confirmer</a>
                </div>
            </div>
        </div>
    </div>
