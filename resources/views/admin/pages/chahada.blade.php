                        ...
                        <div class="col-lg-8">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Ajouter une chahada</h6>
                                </div>
                                @if(Session::has('chahadaAdded'))
                                <div class="alert alert-success" role="alert">
                                    {{Session::get('chahadaAdded')}}
                                </div>
                                ...
                                @endif
                                <div class="card-body">
                                    <form id="edit" action="/addChahada" method="POST">
                                        @csrf
