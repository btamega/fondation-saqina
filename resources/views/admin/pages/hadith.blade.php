                        ...
                        <div class="col-lg-8">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Ajouter un hadith</h6>
                                </div>
                                @if(Session::has('hadithAdded'))
                                <div class="alert alert-success" role="alert">
                                    {{Session::get('hadithAdded')}}
                                </div>
                                ...
                                @endif
                                <div class="card-body">
                                    <form id="edit" action="/addHadith" method="POST">
                                        @csrf
                                        <div class="form-group row">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <input type="text" name="title" class="form-control form-control-user" id="exampleFirstName"
                                                    placeholder="Titre du hadith" required><small><span style="color: red">(*)</span></small>
                                                
                                            </div>
                                        </div>
                                        <textarea name="hadith" id="summernote" cols="30" rows="10" required></textarea>
