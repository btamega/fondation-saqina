          ...
          <div  class="u-layout">
            <div class="u-container-style u-layout-cell u-size-30 u-white">
              <div style="background-color: #e5e5e5" class="u-container-layout u-valign-top">
                @foreach($invocationsResult as $invocation)
                  <h6 style="text-align: center" class="u-custom-font u-text u-text-font u-text-palette-3-base u-text-1">{{$invocation->Titre}}</h6>
