    ...
    <div class="container">
      <div class="box">
        <div class="center gap">
          <h1 style="font-family:'Bodoni MT', 'Didot', Didot LT STD; text-align:center">FATWAS</h1> <br>
          <ol>
              <li class="li">
              ...
              <li class="li">
                ...
                <p>
                    ...
                    Si le musulman appartenant au commun des musulmans pose une question sur un cas qui ne s’est pas encore produit, répondre n’est pas une obligation. <br>
              ...
              <li class="li">
                <h3 style="font-family: 'Bodoni MT', 'Didot', 'Didot LT STD';color:rgb(226, 97, 97)">
                    Conditions relatives au moustafti :
              ...
              <li class="li">
                ...
                <p>
                    <ol>
                        <li class="list">S’assurer que le cas exposé soit réel.</li>
                        <li class="list">Le cas doit être sujet à l’ijtihad</li>
                        <li class="list">Bien saisir le cas : statuer sur un cas découle de la conception de ce dernier.</li>
                        <li class="list">La vérification et la consultation des spécialistes en la matière.</li>
                        <li class="list">Tenir compte des finalités et des conséquences de l’application des prescriptions (ma- aalat al-af’aal)</li>
                        <li class="list">Bienséances de l’ifta : <br>
                            L’imam Ahmed dit : L’homme ne doit s’adonner à la fatwa à moins qu’il soit doté de cinq qualités :
                            <ol>
                                <li class="list">Avoir une bonne intention, car sans intention, aucune lumière ne se verra sur lui ni sur sa parole.</li>
                                <li class="list">Faire preuve d’indulgence, de dignité et de sérénité</li>
                                <li class="list">Il doit maîtriser le sujet</li>
                                <li class="list">Posséder l’indispensable pour vivre, sinon les gens le marcheront</li>
                                <li class="list">Connaître des gens.</li>
                            </ol>
                        </li>
                        <li class="list"> Facteurs de changement de la fatwa :
                            <p>
